    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed bottom-24 left-4 right-4 z-[1000] bg-slate-900 text-white p-4 rounded-2xl shadow-2xl flex items-center justify-between md:hidden border border-slate-700"
        >
