...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} h-full antialiased scroll-smooth`}>
      ...
      <body className="min-h-[100dvh] flex flex-col bg-[#f5f7fa] overscroll-none overflow-x-hidden selection:bg-green-100" style={{ fontFamily: "'Inter', sans-serif", touchAction: 'pan-y' }}>
        <AuthProvider>
          <Navbar />
